...
abstract class AbstractFlashcardViewer :
    ...
    private var mUseTimerDynamicMSQuestion: Long = 0
    ...
    private fun displayCardQuestion(reload: Boolean) {
        val msg = "displayCardQuestion(): " + System.currentTimeMillis()
        Timber.d(msg)
        sDisplayAnswer = false
    ...
    open fun displayCardAnswer() {
        ...
        Timber.d("displayCardAnswer()" +System.currentTimeMillis() )
            ...
            if (!useTTS) { // Text to speech not in effect here
                if (doAudioReplay && replayQuestion && sDisplayAnswer) {
                    ...
                    if (mAutomaticAnswer.isEnabled()) {
                        ...
                        mUseTimerDynamicMS = mSoundPlayer.getSoundsLength(SoundSide.ANSWER)
                        mUseTimerDynamicMSQuestion = mSoundPlayer.getSoundsLength(SoundSide.QUESTION)
                        Timber.d("question_duration = " + mUseTimerDynamicMSQuestion)
                        Timber.d("answer_duration = " + mUseTimerDynamicMS)
                    }
                }
